...
Partial Class WishList
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(WishList))
        ...
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(1428, 100)
        Panel1.TabIndex = 0
        ' 
        ' Button1
        ' 
        Button1.BackColor = Color.FromArgb(CByte(198), CByte(160), CByte(246))
        Button1.Dock = DockStyle.Right
        Button1.Font = New Font("Arial", 14.25F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        Button1.ForeColor = Color.FromArgb(CByte(24), CByte(25), CByte(38))
        Button1.Location = New Point(1252, 0)
        Button1.Name = "Button1"
        Button1.Size = New Size(176, 100)
        Button1.TabIndex = 3
        ...
        DataGridView1.Size = New Size(1428, 602)
